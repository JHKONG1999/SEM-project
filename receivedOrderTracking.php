...
<head>
    ...
    <div class="container-fluid">
        <ul class="nav navbar-nav">
         <li><a href="customerTracking.php">customer tracking list</a></li>
        <li class="active"><a href="receivedOrderTracking.php">Order History</a></li>
         </ul>
    </div>
    </nav>
</head>
...
<?php
	...
	$data = $tracking->viewOrderHistory($Cus_ID);
